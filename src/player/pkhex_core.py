"""
PKHeX Core Integration Module

Provides Pokemon data extraction using PKHeX.Core.dll via pythonnet.
Extracts base stats, abilities, types, and legal moves for Pokemon.
"""
